...
-- Make your email an admin (CHANGE THIS TO YOUR EMAIL!)
-- UPDATE users SET is_admin = true WHERE email = 'your-email@example.com';

-- For development/testing, you can also do this:
-- UPDATE users SET is_admin = true WHERE email LIKE '%@example.com';
